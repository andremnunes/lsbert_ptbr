...
def main():
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        for i in range(eval_size):          
            ...
            pre_word, list_candidate_words = substitution_ranking(mask_words[i], mask_context, candidate_words, fasttext_dico, fasttext_emb,word_count,tokenizer,model,mask_labels[i])
            ...
            print('Palavras candidatas BERT:', SS[i])
