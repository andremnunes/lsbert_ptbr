...
def main():
    ...
    parser.add_argument("--bert_model", default=None, type=str, required=True,
                        ...
                        "bert-large-uncased, bert-base-cased, bert-large-cased, bert-base-multilingual-uncased, neuralmind/bert-base-portuguese-uncased, "
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        for i in range(eval_size):
            ...
            print('Palavras candidatas:', candidate_words)
